...
export default function BassLab(){
 ...
 {view==="courseLesson"&&<LessonWorkspace
  ...
  instruction={<>
   ...
   {courseStep===1&&<PacedReader className="hearStage" revealAll={courseIndex<courseCompleted}><article><span>HEAR BEFORE YOU PLAY</span><h2>Build an internal prediction.</h2><p>Listening is not passive exposure. Every round has a prediction, a sound and a verbal answer. Keep the bass muted until the imagined pitch feels specific.</p></article>
   ...
   {courseStep===2&&<PacedReader className="mapStage" revealAll={courseIndex<courseCompleted}><article><span>MAP FUNCTION TO THE BASS</span><h2>One sound. Several physical routes.</h2><p>Say degree, note name and expected function before every click. The objective is not one memorized box; it is direct access from sound to any useful register.</p></article>
   ...
   {courseStep===4&&<PacedReader className="applyStage" revealAll={courseIndex<courseCompleted}><article><span>MUSICAL APPLICATION</span><h2>{course.application}</h2><p>The concept is learned only when it survives groove, phrasing, listening and choice. Record one uninterrupted 16-bar take; recovery is part of the mission.</p></article>
   ...
   {courseStep===5&&<PacedReader className="passStage" revealAll={courseIndex<courseCompleted}><article><span>LESSON JURY</span><h2>{course.assessment}</h2><p>Use one unedited recording. Score evidence from that take—not how well you believe you understand the page.</p></article>
