...
description: Anti-slop frontend skill for landing pages, portfolios, and redesigns that infers the design direction from the brief and ships interfaces that do not look templated. Audit-first on redesigns, with real design systems and a strict pre-flight check.
---
