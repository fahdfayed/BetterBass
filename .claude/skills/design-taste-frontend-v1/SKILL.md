...
description: The original v1 taste-skill, preserved for projects depending on its exact behavior. Use this install name only for exact backward compatibility, since design-taste-frontend (v2) is the current default.
---
