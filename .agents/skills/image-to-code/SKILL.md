---
name: image-to-code
description: Elite website image-to-code skill for Codex that generates the design image(s) first, analyzes them deeply, then implements the website to match as closely as possible. Prefers large, readable, section-specific images over tiny compressed boards, and keeps the hero clean, spacious, and visible on a small laptop.
---
